        ...
        <div className="controls">
          ...
          <div>
            ...
            >
              ...
              <ToggleButton value={"answer"} onClick={() => setType("answer")} id="answersBtn">
                Answers
              </ToggleButton>
              <ToggleButton
                value={"comment"}
            ...
            <div key={idx} className="content-row">
              ...
              <div className="icons">
                <Tooltip title="Delete">
                  <IconButton onClick={() => handleDelete(data._id)} id="deleteBtn">
                    <Close color="warning" />
                  </IconButton>
                </Tooltip>
                <Tooltip title="Ignore">
                  <IconButton onClick={() => handleResolve(data._id)} id="ignoreBtn">
                    <Check color="success" />
                  </IconButton>
                </Tooltip>
              </div>
